...
namespace Rendering
{
    ...
    ModelFromFile::ModelFromFile(Game& game, Camera& camera, const std::string modelFilename, const std::string texFilename)
	...
	void ModelFromFile::SetPosition(const float rotateX, const float rotateY, const float rotateZ, 
    ...
    void ModelFromFile::Initialize()
    {
       ...
       // std::wstring textureName = L"Content\\Textures\\EarthComposite.jpg";
		//"Content\\Textures\\bench.jpg"
		std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>> converter;
		std::wstring textureName = converter.from_bytes(texFile);
